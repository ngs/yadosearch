...
final class StubProxyServer: URLProtocol {
    ...
    struct Script: Sendable {
        ...
        /// The status a failing page answers with. Both providers refusing is a
        /// 502 whose body is still the merged shape, which the client reads
